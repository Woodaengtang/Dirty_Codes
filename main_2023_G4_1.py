    ...
    if Tello_1.tracking:
        ...
        if class_no == 0:
            ...
            if y < -70:
                ...
                move_up = 20
            # 타겟의 높이가 -70~70 이내의 범위에 없을 시 고도 조정
            ...
            if x > 70:
                ...
                move_right = -20
                # 왼쪽으로
            # 타켓의 중심이 -70~70 이내의 범위에 없을 시 드론 roll 기동
            
            if w >= 200:        # 270
                # 인식 후 범위 내에 들어올 시 yaw 기동
                # move_front = 5        # 0
                # move_right = 0
                if class_no == 2 and w >= 250:
                    # 왼쪽 화살표 인식할 시
                    TurnLeft = True
                elif class_no == 3 and w >= 250:
                    # 오른쪽 화살표 인식할 시
                    TurnRight = True
                elif class_no == 1:
                    LandingSign = True
        ...
        if TurnLeft == True:
            ...
            move_right, move_up, move_front, yaw = 0, 0, -5 ,0
            Tello_1.land()
